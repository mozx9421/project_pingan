                ...
                <div class="table-responsive">
                  ...
                  <table class="table-white col-xl-12">
                    <tr>
                      ...
                      <td align="right">
                        <div class="col-xl-12">
                        <a href="editstock=1.php"><button type="button" class="btn btn-outline-primary"><i class="fas fa-plus"></i> ปรับสต๊อก</button></a>
                        </div>
                      </td>
                    </tr>
                  </table>
                ...
                <div class="table-responsive table-white table-striped">
                  <table class="table align-items-center table-flush">
                    ...
                    <th><h6 class="text-gray text-ml mb-0">ลำดับ</h6></th>
                      <th><h6 class="text-gray text-ml mb-0">รหัสสต็อก</h6></th>
                      <th><h6 class="text-gray text-ml mb-0">สถานะ</h6</th>
                      <th><h6 class="text-gray text-ml mb-0">วันเวลาที่ปรับสต๊อก</h6></th>
                      <th><h6 class="text-gray text-ml mb-0">ผู้ปรับสต๊อก</h6></th>
                    ...
                    <tr align="center">
                      ...
                      <td class="text-info"><?php echo $fetch['stock_status']?></td>
