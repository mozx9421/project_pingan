                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="crud_table">
                                                <thead>
                                                    ...
                                                    <th width="50%"><h6 class="mb-0">สินค้า</h6></th>
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            ...
                                            $('#add').click(function() {
                                                ...
                                                html_code += "<td><button type='button' name='remove' data-row='row" + count + "' class='btn btn-outline-danger btn-xs remove'><i class='fas fa-minus'></button></td>";
                                                html_code += "</tr>";
