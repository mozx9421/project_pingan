                      ...
                      <td align="right">
                        <div class="col-xl-12">
                          <a href="stock_out=1.php">
                            <button type="button" class="btn btn-outline-primary"><i class="fas fa-plus"></i> เบิกออกสินค้า</button>
                          </a>
                        </div>
                      </td>
                    </tr>
                ...
                <div class="table-responsive table-white table-striped">
                  <table class="table align-items-center table-flush">
                    ...
                    <th><h6 class="text-gray text-ml mb-0">ลำดับ</h6></th>
                      ...
                      <th><h6 class="text-gray text-ml mb-0">วันเวลาที่เบิกออกสินค้า</h6></th>
                      <th><h6 class="text-gray text-ml mb-0">ผู้เบิกออกสินค้า</h6></th>
                    ...
                    <tr align="center">
                      ...
                      <td class="text-danger"><?php echo $fetch['stock_status']?></td>
