                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="crud_table">
                                                <thead>
                                                    ...
                                                    <th width="20%"><h6 class="mb-0">ตัวเลือก</h6></th>
                                                    <th width="30%"><h6 class="mb-0">หมายเหตุ</h6></th>
                                                    <th width="5%"></th>
                                                ...
                                                <tbody class="data_product">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td contenteditable="true" ><input type="number" value="1" min="1" max="50" class="form-control product_qty" id="product_qty" name="product_qty" required></td>
                                                        <td contenteditable="true" ><select class="form-control stock_status" id="stock_status <?php echo "$i" ?>" name="stock_status<?php echo "$i" ?>" placeholder="" onkeyup="keyuppername(<?php echo $i ?>) " required>
                                                                <option value="ปรับเพิ่มสินค้า">เพิ่มสินค้า</option>
                                                                <option value="ปรับลดสินค้า">ลดสินค้า</option>
                                                            </select></td>
                                            ...
                                            <br>
                                            <div align="center">
                                                <button type="button" name="save" id="save" class="btn btn-outline-success">Save</button>
                                            </div>
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            ...
                                            $('#add').click(function() {
                                                ...
                                                html_code += "<td contenteditable='true' ><select id='stock_status' name='stock_status' class='form-control col-md-12 stock_status' required><option value='ปรับเพิ่มสินค้า'>เพิ่มสินค้า</option><option value='ปรับลดสินค้า'>ลดสินค้า</option></td>";
                                                ...
                                                html_code += "<td><button type='button' name='remove' data-row='row" + count + "' class='btn btn-outline-danger btn-xs remove'><i class='fas fa-minus'></i></button></td>";
                                                html_code += "</tr>";
                                            ...
                                            $('#save').click(function() {
                                                ...
                                                $('.data_product tr').each(function (a, b) {
                                                    ...
                                                    data.push({
                                                        ...
                                                        stock_status:$('.stock_status', b).val(),
