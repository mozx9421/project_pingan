                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="crud_table">
                                                <thead>
                                                    ...
                                                    <th width="20%"><h6 class="mb-0">จำนวน(เเพ็ค)</h6></th>
                                                    <th width="40%"><h6 class="mb-0">วันที่หมดอายุ</h6></th>
                                                    <th width="5%"></th>
                                                </thead>
                                                <tbody class="data_product">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td contenteditable="true" ><input type="date" id="product_exp<?php echo "$i" ?>" name="product_exp<?php echo "$i" ?>" placeholder="" onkeyup="keyuppermiddle(<?php echo $i ?>)" class="form-control col-md-12 product_exp" required></td>
                                                        <td>
                                                            <div align="right">
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            ...
                                            $('#add').click(function() {
                                                ...
                                                html_code += "<td contenteditable='true' ><input type='date' id='product_exp' name='product_exp' class='form-control col-md-12 product_exp' required></td>";
